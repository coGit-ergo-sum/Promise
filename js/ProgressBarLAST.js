...
class ProgressBar {
    constructor(id) {
      // Assicuriamoci che 'this' sia correttamente referenziato.  In questo caso non serve var _this = this;
      // ma lo lascio per didattica
      var _this = this;
      ...
      this._text = function(value) { this._$span.text(value); };
  
      let _intervalId = 0;
      let _isStopped = false;
      // ---------------------------------------------------------- //
  
      this.reset = this.reset.bind(this); // Assicuriamo che 'this' sia legato all'istanza.
      this.reset(); // Chiama il metodo reset all'inizializzazione
    }
  
    // Sets the width of the progress bar
    width(value) {
      this._$bar.width((value % 101) + '%');
    }
